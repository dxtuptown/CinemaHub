    ...
    public class MovieController : Controller
    {
        ...
        public IActionResult Create(Movie movie, IFormFile? fileImage, IFormFile? fileVideo)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    // Check định dạng of file, make sure it's an image file (.jpg / .png)
                    ...
                    {
                        //Sử dụng UploadImageService để tải lên và lưu trữ đường dẫn của hình ảnh hoặc video.
        ...
        public async Task<IActionResult> Update(Movie movie, IFormFile? fileImage, IFormFile? fileVideo)
        {
            ...
            //Cập nhật thông tin của một phim đã tồn tại.
